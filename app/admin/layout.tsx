...
import { BrainCircuit, LayoutDashboard, Users, BookOpen, CreditCard, Settings, LogOut, Bell, Search } from "lucide-react";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";

export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-[#050505] text-[#e0e0e0] font-sans flex">
      {/* Sidebar - Collapsible (Simplified for now) */}
